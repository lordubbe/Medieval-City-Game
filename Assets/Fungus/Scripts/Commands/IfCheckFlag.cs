...
namespace Fungus
{
	...
	[CommandInfo("Scripting", 
		"If CheckFlag", 
		"Invokes a method of a component via reflection. Supports passing multiple parameters and storing returned values in a Fungus variable.")]
	public class IfCheckFlag : Command
	{
		...
		[SerializeField] protected InvokeMethodParameter2[] methodParameters;
		...
		protected virtual void Awake()
		{
			...
			{
				componentType = ReflectionHelper2.GetType(targetComponentAssemblyName);
			}
		...
		protected virtual System.Type[] GetParameterTypes()
		{
			...
			for (int i = 0; i < methodParameters.Length; i++)
			{
				...
				var objType = ReflectionHelper2.GetType(item.objValue.typeAssemblyname);
	...
	[System.Serializable]
	public class InvokeMethodParameter2
	{
		[SerializeField]
		public ObjectValue2 objValue;
	...
	public class ObjectValue2
	{
		...
		public object GetValue()
		{
			...
			case "UnityEngine.Vector3":
				return vector3Value;
			default:
				var objType = ReflectionHelper2.GetType(typeAssemblyname);
